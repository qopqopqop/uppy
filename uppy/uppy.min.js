...
"use strict";module.exports=require("./lib/promise-settle");
},{"./lib/promise-settle":54}],54:[function(require,module,exports){
"use strict";function settle(e){return Promise.resolve(e).then(_settle)}function _settle(e){if(!Array.isArray(e))throw new TypeError("Expected an array of Promises");return Promise.all(e.map(_settlePromise))}function _settlePromise(e){return Promise.resolve(e).then(_promiseResolved,_promiseRejected)}function _promiseResolved(e){return{isFulfilled:_true,isRejected:_false,value:function(){return e},reason:_isFulfilled}}function _promiseRejected(e){return{isFulfilled:_false,isRejected:_true,value:_isRejected,reason:function(){return e}}}function _true(){return!0}function _false(){return!1}function _isRejected(){throw new Error("Promise is rejected")}function _isFulfilled(){throw new Error("Promise is fulfilled")}module.exports=settle;
...
"use strict";var _appendChild=require("yo-yoify/lib/appendChild"),_svgNamespace="http://www.w3.org/2000/svg",_require=require("../../core/Utils"),getETA=_require.getETA,getSpeed=_require.getSpeed,prettyETA=_require.prettyETA,getFileNameAndExtension=_require.getFileNameAndExtension,truncateString=_require.truncateString,copyToClipboard=_require.copyToClipboard,prettyBytes=require("prettier-bytes"),FileItemProgress=require("./FileItemProgress"),getFileTypeIcon=require("./getFileTypeIcon"),_require2=require("./icons"),iconEdit=_require2.iconEdit,iconCopy=_require2.iconCopy;module.exports=function(e){var t,i,r,s,a,n,p,l,o,d,u,c,m,b,g,A,y,h,E,_,v,C,S,I,f,U,F,D=e.file,N=e.acquirers,q=D.progress.uploadComplete,w=D.progress.uploadStarted,T=D.progress.uploadStarted&&!D.progress.uploadComplete,k=D.isPaused||!1,L=getFileNameAndExtension(D.meta.name)[0],x=e.isWide?truncateString(L,15):L;return o=document.createElement("li"),o.setAttribute("id","uppy_"+String(D.id)),o.setAttribute("title",""+String(D.meta.name)),o.setAttribute("class","UppyDashboardItem\n                        "+String(T?"is-inprogress":"")+"\n                        "+String(q?"is-complete":"")+"\n                        "+String(k?"is-paused":"")+"\n                        "+String(e.resumableUploads?"is-resumable":"")),_appendChild(o,[" ",(s=document.createElement("div"),s.setAttribute("class","UppyDashboardItem-preview"),_appendChild(s,[" ",(t=document.createElement("div"),t.setAttribute("style","background-color: "+String(getFileTypeIcon(D.type.general,D.type.specific).color)),t.setAttribute("class","UppyDashboardItem-previewInnerWrap"),_appendChild(t,[" ",D.preview?(d=document.createElement("img"),d.setAttribute("alt",""+String(D.name)),d.setAttribute("src",""+String(D.preview)),d):(A=document.createElement("div"),A.setAttribute("class","UppyDashboardItem-previewIconWrap"),_appendChild(A,[" ",(u=document.createElement("span"),u.setAttribute("style","color: "+String(getFileTypeIcon(D.type.general,D.type.specific).color)),u.setAttribute("class","UppyDashboardItem-previewIcon"),_appendChild(u,[getFileTypeIcon(D.type.general,D.type.specific).icon]),u)," ",(g=document.createElementNS(_svgNamespace,"svg"),g.setAttribute("width","72"),g.setAttribute("height","93"),g.setAttribute("viewBox","0 0 72 93"),g.setAttribute("class","UppyDashboardItem-previewIconBg"),_appendChild(g,[(b=document.createElementNS(_svgNamespace,"g"),_appendChild(b,[(c=document.createElementNS(_svgNamespace,"path"),c.setAttribute("d","M24.08 5h38.922A2.997 2.997 0 0 1 66 8.003v74.994A2.997 2.997 0 0 1 63.004 86H8.996A2.998 2.998 0 0 1 6 83.01V22.234L24.08 5z"),c.setAttribute("fill","#FFF"),c),(m=document.createElementNS(_svgNamespace,"path"),m.setAttribute("d","M24 5L6 22.248h15.007A2.995 2.995 0 0 0 24 19.244V5z"),m.setAttribute("fill","#E4E4E4"),m)]),b)]),g)," "]),A)," "]),t)," ",(r=document.createElement("div"),r.setAttribute("class","UppyDashboardItem-progress"),_appendChild(r,[" ",(i=document.createElement("button"),i.setAttribute("type","button"),i.setAttribute("title",""+String(q?"upload complete":e.resumableUploads?D.isPaused?"resume upload":"pause upload":"cancel upload")),i.onclick=function(t){q||(e.resumableUploads?e.pauseUpload(D.id):e.cancelUpload(D.id))},i.setAttribute("class","UppyDashboardItem-progressBtn"),_appendChild(i,[" ",FileItemProgress({progress:D.progress.percentage,fileID:D.id})," "]),i)," ",e.showProgressDetails?(y=document.createElement("div"),y.setAttribute("title",""+String(e.i18n("fileProgress"))),y.setAttribute("aria-label",""+String(e.i18n("fileProgress"))),y.setAttribute("class","UppyDashboardItem-progressInfo"),_appendChild(y,[" ",D.isPaused||q?null:(h=document.createElement("span"),_appendChild(h,[prettyETA(getETA(D.progress))," ・ ↑ ",prettyBytes(getSpeed(D.progress)),"/s"]),h)," "]),y):null," "]),r)," "]),s)," ",(p=document.createElement("div"),p.setAttribute("class","UppyDashboardItem-info"),_appendChild(p,[" ",(a=document.createElement("h4"),a.setAttribute("title",""+String(L)),a.setAttribute("class","UppyDashboardItem-name"),_appendChild(a,[" ",D.uploadURL?(E=document.createElement("a"),E.setAttribute("href",""+String(D.uploadURL)),E.setAttribute("target","_blank"),_appendChild(E,[" ",D.extension?x+"."+D.extension:x," "]),E):D.extension?x+"."+D.extension:x," "]),a)," ",(n=document.createElement("div"),n.setAttribute("class","UppyDashboardItem-status"),_appendChild(n,[" ",D.data.size&&(_=document.createElement("div"),_.setAttribute("class","UppyDashboardItem-statusSize"),_appendChild(_,[prettyBytes(D.data.size)]),_)," ",D.source&&(v=document.createElement("div"),v.setAttribute("class","UppyDashboardItem-sourceIcon"),_appendChild(v,[" ",N.map(function(t){var i;if(t.id===D.source)return i=document.createElement("span"),i.setAttribute("title",String(e.i18n("fileSource"))+": "+String(t.name)),_appendChild(i,[t.icon()]),i})," "]),v)," "]),n)," ",w?null:(C=document.createElement("button"),C.setAttribute("type","button"),C.setAttribute("aria-label","Edit file"),C.setAttribute("title","Edit file"),C.onclick=function(t){return e.showFileCard(D.id)},C.setAttribute("class","UppyDashboardItem-edit"),_appendChild(C,[" ",iconEdit()]),C)," ",D.uploadURL?(S=document.createElement("button"),S.setAttribute("type","button"),S.setAttribute("aria-label","Copy link"),S.setAttribute("title","Copy link"),S.onclick=function(){copyToClipboard(D.uploadURL,e.i18n("copyLinkToClipboardFallback")).then(function(){e.log("Link copied to clipboard."),e.info(e.i18n("copyLinkToClipboardSuccess"),"info",3e3)}).catch(e.log)},S.setAttribute("class","UppyDashboardItem-copyLink"),_appendChild(S,[iconCopy()]),S):null," "]),p)," ",(l=document.createElement("div"),l.setAttribute("class","UppyDashboardItem-action"),_appendChild(l,[" ",q?null:(F=document.createElement("button"),F.setAttribute("type","button"),F.setAttribute("aria-label","Remove file"),F.setAttribute("title","Remove file"),F.onclick=function(){return e.removeFile(D.id)},F.setAttribute("class","UppyDashboardItem-remove"),_appendChild(F,[" ",(U=document.createElementNS(_svgNamespace,"svg"),U.setAttribute("width","22"),U.setAttribute("height","21"),U.setAttribute("viewBox","0 0 18 17"),U.setAttribute("class","UppyIcon"),_appendChild(U,[" ",(I=document.createElementNS(_svgNamespace,"ellipse"),I.setAttribute("cx","8.62"),I.setAttribute("cy","8.383"),I.setAttribute("rx","8.62"),I.setAttribute("ry","8.383"),I)," ",(f=document.createElementNS(_svgNamespace,"path"),f.setAttribute("stroke","#FFF"),f.setAttribute("fill","#FFF"),f.setAttribute("d","M11 6.147L10.85 6 8.5 8.284 6.15 6 6 6.147 8.35 8.43 6 10.717l.15.146L8.5 8.578l2.35 2.284.15-.146L8.65 8.43z"),f)," "]),U)," "]),F)," "]),l)," "]),o};
...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},yo=require("yo-yo"),nanoraf=require("nanoraf"),_require=require("../core/Utils"),findDOMElement=_require.findDOMElement,getFormData=require("get-form-data");module.exports=function(){function t(e,o){_classCallCheck(this,t),this.core=e,this.opts=o||{},this.update=this.update.bind(this),this.mount=this.mount.bind(this),this.install=this.install.bind(this),this.uninstall=this.uninstall.bind(this)}return t.prototype.update=function(t){void 0!==this.el&&this.updateUI&&this.updateUI(t)},t.prototype.mount=function(e,o){var n=this,i=o.id,r=findDOMElement(e);if(this.updateUI=nanoraf(function(t){n.el=yo.update(n.el,n.render(t))}),r){if(this.core.log("Installing "+i+" to a DOM element"),this.opts.getMetaFromForm&&"FORM"===r.nodeName){var a=getFormData(r);this.core.setMeta(a)}return this.opts.replaceTargetContent&&(r.innerHTML=""),this.el=o.render(this.core.state),r.appendChild(this.el),this.target=r,r}var s=void 0;if("object"===(void 0===e?"undefined":_typeof(e))&&e instanceof t)s=e;else if("function"==typeof e){var l=e;this.core.iteratePlugins(function(t){if(t instanceof l)return s=t,!1})}if(s){var u=s.id;return this.core.log("Installing "+i+" to "+u),this.target=s,s.addTarget(o)}throw this.core.log("Not installing "+i),new Error("Invalid target option given to "+i)},t.prototype.render=function(t){throw new Error("Extend the render method to add your plugin to a DOM element")},t.prototype.addTarget=function(t){throw new Error("Extend the addTarget method to add your plugin to another plugin's target")},t.prototype.unmount=function(){this.el&&this.el.parentNode&&this.el.parentNode.removeChild(this.el),this.target=null},t.prototype.install=function(){},t.prototype.uninstall=function(){this.unmount()},t}();
